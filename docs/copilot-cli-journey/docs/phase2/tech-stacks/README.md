...
详见 [完整对比分析](../../../modules/phase2/m5/tech-stacks/stack-comparison.md)

---

## 🎯 三大框架深度学习

### 1️⃣ [FastAPI — 代码即文档](../../../modules/phase2/m5/tech-stacks/fastapi.md)
...
### 2️⃣ [gRPC — 高性能多语言通信](../../../modules/phase2/m5/tech-stacks/grpc.md)
...
### 3️⃣ [GraphQL — 灵活的数据查询语言](../../../modules/phase2/m5/tech-stacks/graphql.md)
...
- [完整对比分析](../../../modules/phase2/m5/tech-stacks/stack-comparison.md)
- [所有文档](../../../README.md)
...
3. **对比理解**
   - 完成所有三个框架后，看 [对比分析](../../../modules/phase2/m5/tech-stacks/stack-comparison.md)
   - 理解何时选择哪个框架
