...
|CreateDestHttpUrl|none|hmac-sha1|用于创建消息流转中的url地址|
...
|:-------|:------|:--------|
|正式环境|10433748.api.ctwing.cn/aep_subscribe_north|10433748.api.ctwing.cn/aep_subscribe_north|
...
### API名称：CreateDestHttpUrl   版本号: 20231109105327
...
描述：
url:必填" + "desc:可选" + "isVpn:可选，0:不是；1:是。默认0" + 
			"token:可选" + "isSafemode:可选，0:不是；1:是。
