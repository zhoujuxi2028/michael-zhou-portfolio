...
|QueryCommandDetailList|none|hmac-sha1|批量查询指令明细列表|
...
|:-------|:------|:--------|
|正式环境|10433748.api.ctwing.cn/aep_device_command|10433748.api.ctwing.cn/aep_device_command|
...
### API名称：QueryCommandDetailList   版本号: 20241218142112
...
|名称 | 位置| 类型| 必填| 描述|
|:-------|:------|:--------|:--------|:--------|
|MasterKey|HEAD|String|true|产品MasterKey，在该设备所属产品的概况中可以查看|
|productId|QUERY|Long|true|产品ID|
|deviceId|QUERY|String|true|设备ID|
|startTime|QUERY|Long|true|起始时间戳，精确到毫秒, 例如：1539565440000|
|endTime|QUERY|Long|true|结束时间戳，精确到毫秒, 例如：1539565460000|
|pageTime|QUERY|Long|false|分页时间戳，精确到毫秒, 例如：1539565460000；查询第一页时pageTime可不传 或 填endTime，第二页开始需使用返回值中的pageTime，若返回值中pageTime为空，则说明无下一页数据|
...
##### 返回结果示例
{
	...
	"msg": "ok",
	"result": {
		"pageTime": 1539565470000,
		"pageSize": 3,
		"list": [{
				"timeStamp": 1539565460000,
				"commandId": "191533",
				"productId": 10000271,
				"deviceId": "10000271ABC23",
				"deviceSn": null,
