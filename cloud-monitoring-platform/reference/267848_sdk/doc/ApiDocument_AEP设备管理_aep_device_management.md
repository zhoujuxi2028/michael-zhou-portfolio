...
|BatchCreateDevice|none|hmac-sha1|批量增加设备|
...
|:-------|:------|:--------|
|正式环境|10433748.api.ctwing.cn/aep_device_management|10433748.api.ctwing.cn/aep_device_management|
...
### API名称：BatchCreateDevice   版本号: 20230330043852
...
devices: 
      deviceName: 设备名称，必填;  
      imei: imei号，lwm2m协议必填;
      deviceSn: 设备编号，非lwm2m协议协议必填;  
      imsi:总长度不超过15位，使用0~9的数字，String类型,lwm2m协议选填;
      pskValue:由大小写字母加0-9数字组成的16位字符串,lwm2m协议选填,默认字符串类型;
注意：最多一次可以添加100个设备，单产品下最多可添加1000000个设备。
