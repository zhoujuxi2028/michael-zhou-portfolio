...
### 1. AppID和Secret (来自vendor-b项目)
**文件**: `/vendor-b/zc_backend/nmps-impl/src/main/java/cn/com/git/nmps/impl/iot/utils/Constant.java`
```java
// Line 20-21 的硬编码值:
...
### 3. 实际使用位置
**文件**: `/vendor-b/zc_backend/nmps-impl/src/main/java/cn/com/git/nmps/impl/iot/apptoken/AuthUtils.java`
```java
// Line 45-46 的硬编码使用:
...
```
=== 电信物联网平台API验证程序 ===
配置来源: vendor-b/zc_backend/.../Constant.java
...
1. **硬编码配置**: 程序使用的所有配置值都来自vendor-b项目的实际源代码
