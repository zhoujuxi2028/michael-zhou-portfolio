...
public class IoTMockTest {
    ...
    private void testAuthenticationFlow() {
        ...
        try {
            ...
            // 构建认证请求 (参考vendor-b系统AuthUtils.java)
            Map<String, Object> authData = new HashMap<>();
            authData.put("appId", "vendor-b_test_app_001");
            authData.put("secret", "vendor-b_secret_xyz789");
            ...
            headers.put("User-Agent", "Vendor-BIoT/1.0 (Connection-Test)");
    ...
    private void testDeviceRegistration() {
        ...
        try {
            ...
            // 构建设备注册数据 (参考vendor-b系统TDeviceService)
            Map<String, Object> deviceInfo = new HashMap<>();
            deviceInfo.put("deviceId", "ZC_DEVICE_001");
            deviceInfo.put("deviceName", "Vendor C科技测试设备001");
    ...
    private void testDeviceCommand() {
        ...
        try {
            ...
            commandData.put("callbackUrl", "http://vendor-b.callback.com/iot/command/result");
    ...
    private ConnectionResult performHttpRequest(String method, String urlString, Map<String, String> headers, String body) throws Exception {
        ...
        try {
            ...
            // 设置请求头
            connection.setRequestProperty("User-Agent", "IoT-Mock-Test/1.0 (vendor-b-reference)");
            if (headers != null) {
