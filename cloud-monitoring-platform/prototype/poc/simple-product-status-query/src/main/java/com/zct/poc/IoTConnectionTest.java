...
/**
 * 物联网连接测试程序
 * 参考vendor-b系统的IoT连接实现，提供详细的连接测试和日志记录
 */
public class IoTConnectionTest {
    ...
    private void testTelecomAuthFlow() {
        ...
        logInfo("参考vendor-b系统AuthUtils.java实现");
    ...
    private void testDeviceRegistration() {
        logInfo("测试设备注册API");
        logInfo("参考vendor-b系统TDeviceService设备注册实现");
    ...
    private ConnectionResult performHttpRequest(String method, String urlString, Map<String, String> headers, String body) throws Exception {
        ...
        try {
            ...
            // 设置请求头
            connection.setRequestProperty("User-Agent", "IoT-Connection-Test/1.0 (vendor-b-reference)");
            if (headers != null) {
