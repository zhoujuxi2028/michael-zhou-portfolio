...
[DEBUG] 设备命令数据: {
  ...
  "callbackUrl": "http://vendor-b.callback.com/iot/command/result",
  "expireTime": 300,
  "priority": "HIGH"
}
...
[IoT-TEST] [DEBUG] 2025-12-26 06:39:54.798 设备命令数据: {"expireTime":300,"callbackUrl":"http://vendor-b.callback.com/iot/command/result"...}
...
- **端点格式**: `/iocm/app/sec/v1.1.0/login` (标准格式)
- **参数格式**: `appId` + `secret` (标准格式)
- **请求方式**: POST + application/x-www-form-urlencoded

### 2. 设备管理验证 ✅
- **TDeviceService.java实现**: 设备注册流程符合标准
...
**本次测试完全达到预期目标，为IoT平台的IoT功能提供了可靠的技术验证。** 🚀